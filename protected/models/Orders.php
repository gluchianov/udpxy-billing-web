...
class Orders extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_user, id_tvpack, start_date, end_date, status, start_operator, end_operator', 'required'),
			array('status', 'numerical', 'integerOnly'=>true),
			array('id_user, id_tvpack, start_operator, end_operator', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_user, id_tvpack, start_date, end_date, status, start_operator, end_operator', 'safe', 'on'=>'search'),
		);
	}
